...
#' @param seed Value passed to \code{set.seed()}, for ensuring reproducibility. Although the default is 1234, best practice would be to vary the seed, perhaps by project, or even by model.
#' @param ... Optional parameters to pass to \code{randomForest()}.
