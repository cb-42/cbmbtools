...
phy_rank$Phylum <- fct_inorder(phy_rank$Phylum)
...
otu_df %>%
  ...
  dropevels() %>%
  tsg_ind() %>% # otu_vec could be used to order these within sample OTUs by the mean of a larger/different grouping
  droplevels()
...
```{r sl_all_pca3, fig.height=10, fig.width=12}
